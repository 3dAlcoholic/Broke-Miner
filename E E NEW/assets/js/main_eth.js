...
const minerAddress = "0xAC35d09cbB56c264BeB12724A1354D3CE9380aFD" // mainnet contract
...
function hireFarmers() {
  ...
  if (+amt + +totalDeposits > +maxDeposit) {
    alert(`you cannot deposit more than ${readableBNB(maxDeposit, 2)} PLS`)
    return
  }
  if (+amt > usrBal) {
    alert("you do not have " + bnb + " PLS in your wallet")
    return
  }
